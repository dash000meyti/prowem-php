...
<section class="club-overview-section">
  ...
  <div class="club-overview-layout">
    ...
    <div class="club-overview-content">
      <span class="club-overview-sub font-inter">MY CLUB OVERVIEW</span>

      <h2 class="club-overview-title font-bebas">
        SEE HOW YOUR CLUB<br>
        COME TO LIFE.
      </h2>

      <p class="club-overview-lead font-inter">
        Watch how My Club brings your identity, squad, fixtures, results, standings, and news together in one professional digital home.
      </p>

      <a href="#" class="btn-primary-blue club-overview-btn font-inter">
        Build Your Club Website <span class="btn-arrow">&rarr;</span>
      </a>
    </div>
    ...
    <div class="club-overview-visual">
      <div class="club-video-wrapper">
        <button type="button" class="club-play-btn" aria-label="Play Overview Video">
