<?php
// forgot.php – Design adapted to Register and Login page (English Version)
$forgot_error = $_SESSION['flash_error'] ?? '';
$forgot_success = $forgot_error ? '' : ($_SESSION['flash_success'] ?? '');
...
.success-message { background: #00C878; padding: 12px; border-radius: 10px; margin-bottom: 20px; color: #000; text-align: center; font-size: 14px; font-weight: 600; }
</style>
...
<div class="auth-page-wrapper">
  <div class="auth-container">
    ...
    <form action="index.php?page=forgot" method="POST" class="auth-form">
