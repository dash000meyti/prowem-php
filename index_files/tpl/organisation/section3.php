<?php
// ORGANISATION SECTION 3: THE COMPLETE OPERATION GRID
?>
<section class="org-operation-section">
  ...
  <!-- Grid Container (3x2 Cards) -->
  <div class="org-operation-grid-container">

    <!-- CARD 1: VENUE & LOGISTICS -->
