...
<section class="org-video-section">
  ...
  <div class="org-video-layout">
    ...
    <div class="org-video-content">
      <span class="org-video-sub font-inter">SEE IT IN ACTION</span>

      <h2 class="org-video-title font-bebas">
        SEE HOW YOUR EVENT<br>
        COMES TO LIFE
      </h2>

      <p class="org-video-lead font-inter">
        See how planning, on-site operations, live production and digital coverage come together to turn an empty venue into a fully delivered event.
      </p>

      <a href="?page=register" class="btn-primary-orange org-video-btn font-inter">
        Start Your Journey <span class="btn-arrow">&rarr;</span>
      </a>
    </div>
    ...
    <div class="org-video-visual">
      <div class="org-video-wrapper">
        <button type="button" class="org-play-btn" aria-label="Play Showcase Video">
