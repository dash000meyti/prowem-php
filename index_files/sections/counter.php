<section class="stats-section">
  <div class="stats-grid">
    ...
    <div class="stats-card color-orange-card">
      ...
      <div class="stats-label font-bebas"><?= t_raw('home.stats.users_html') ?></div>
    </div>
    ...
    <div class="stats-card color-green-card">
      ...
      <div class="stats-label font-bebas"><?= t_raw('home.stats.events_html') ?></div>
    </div>
    ...
    <div class="stats-card color-purple-card">
      ...
      <div class="stats-label font-bebas"><?= t_raw('home.stats.sports_html') ?></div>
    </div>
    ...
    <div class="stats-card color-blue-card">
      ...
      <div class="stats-label font-bebas"><?= t_raw('home.stats.control_html') ?></div>
    </div>
...
<section class="cta-section">
  <div class="cta-content">
    <span class="cta-sub anime-slide"><?= t('home.cta.sub') ?></span>
    <h2 class="font-bebas">
      <span class="cta-title-line anime-slide"><?= t('home.cta.title_1') ?></span>
      <span class="cta-title-line anime-slide"><?= t('home.cta.title_2') ?></span>
    </h2>
    <p class="cta-lead anime-slide"><?= t('home.cta.lead') ?></p>
    <div class="anime-slide">
      <a href="#" class="cta-btn"><?= t('home.cta.button') ?></a>
    </div>
  </div>
</section>
